  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex flex-col min-h-screen">
        <TopBar />
        <div className="pt-8 pl-20 md:pl-80 pr-20 md:pr-48">
          <div className="relative group">
            <h1 className="text-3xl font-bold text-white leading-tight hover:underline cursor-pointer">
              Idaho suspect 'intentionally' set fire in deadly ambush, sheriff says
            </h1>
